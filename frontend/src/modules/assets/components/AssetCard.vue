  ...
  <div
    ...
    <div class="flex items-center justify-between">
      <div class="flex items-center gap-3 flex-1 min-w-0">
        <img :src="asset.image" :alt="asset.name" class="h-10 w-10 rounded-full flex-shrink-0"
        ...
        <div class="flex-1 min-w-0">
          ...
          <div class="mt-1 flex items-center gap-3 text-sm">
            ...
            <span v-if="asset.price_change_percentage_24h !== undefined" :class="[
              'tabular-nums',
      ...
      <FavoriteButton :asset-id="asset.id" :is-favorite="isFavorite" @toggle="$emit('favorite-toggle')" class="ml-2" />
    </div>
  </div>
</template>
