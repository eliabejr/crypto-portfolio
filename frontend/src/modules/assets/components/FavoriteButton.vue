<template>
  ...
  ]" @click.stop="$emit('toggle')" :aria-label="isFavorite ? 'Remover dos favoritos' : 'Adicionar aos favoritos'">
    <svg v-if="isFavorite" class="h-5 w-5 fill-current" viewBox="0 0 24 24" fill="currentColor">
